...
<body>
	<table>
		<tr>
			<td><div class="form-title"><h2>Kaikki omat tallenteesi!</h2></div></td>
			<td></td>
		...
		<td></td>
			...
			class="button" value="Hae tallenteista" /></a></td>
		<td></td>
	...
	<table style="width:90%" class="form-containerlist" border="2" >
		...
		<tr>
			...
			<td class="form-title"><b>Julkaisuvuosi</b></td>
		</tr>
	...
	<c:forEach items="${aaniTallenteet}" var="aaniTallenne">
			<tr>
				...
				<td><a href="poista-aaniTallenne?id=<c:out value='${aaniTallenne.id}' />">Poista</a>
				<a class='muuta' href="aanitallennemuutos.jsp?muuta_id=<c:out value='${aaniTallenne.id}' /><c:out value='${aaniTallenne.name}' />">Muuta</a></td>
			</tr>
	</c:forEach>
</table>
